...
<body>
    ...
    <?php 
        ...
        */
        ...
        echo "Looping Ascending (Meningkat):" . PHP_EOL;
        for ($i = 1; $i <= 20; $i++) {
         echo "I Love PHP - Iterasi ke-$i" . PHP_EOL;
        }


        echo "Looping Descending (Menurun):" . PHP_EOL;
        for ($i = 20; $i >= 1; $i--) {
         echo "I Love PHP - Iterasi ke-$i" . PHP_EOL;
         }
        ...
        */
        ...
        foreach ($numbers as $number) {
            $sisa = $number % 5; // Menghitung sisa bagi
            $rest[] = $sisa; // Menambahkan sisa bagi ke array $rest
        }
        ...
        */
        for ($i = 1; $i <= 5; $i++) {
            ...
            echo PHP_EOL; // Mencetak baris baru setelah setiap baris bintang
        }
